...
public class SqliteHelper5 extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "areadata";
    private static final int DATABASE_VERSION = 1;
    public SqliteHelper5(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE ardata " +
    ...
    public boolean saveUser (String id,String name)
    {
        ...
        if (cursor.getCount() == 0) { // Record does not exist
            ...
            result = db.insert("ardata", null, contentValues);
        } else { // Record exists
            result = db.update("ardata", contentValues, "id=?", new String[] { id });
        }
    ...
    public ArrayList<HashMap<String, Object>> getAllUsers() {
        ...
        String selectQuery = "SELECT  * FROM ardata";
    ...
    public Cursor getUser(String id){
        ...
        String sql = "SELECT * FROM ardata WHERE id=?";
    ...
    public Cursor getUser1(String name){
        ...
        String sql = "SELECT * FROM ardata WHERE name=?";
