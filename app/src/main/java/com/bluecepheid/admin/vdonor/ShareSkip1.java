...
public class ShareSkip1 extends Activity implements LocationListener {
    Button fbshare;
    TextView skip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_share_skip1);
        ...
        if (isNetworkAvailable()) {
            ...
            if (!imagePreferance.equals("")) {
                ...
                RelativeLayout viewToBeShared = (RelativeLayout) LayoutInflater.from(ShareSkip1.this).inflate(R.layout.layout_image1, null);
...
// Without it the view will have a dimension of 0,0 and the bitmap will be null
       ...
       /* if(isNetworkAvailable()) {
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                //g.setFlag(2);
                Intent i = new Intent(ShareSkip1.this,WelcomeActivity.class);
                startActivity(i);
                finish();
    ...
    public void shareImageOnFacebook(String name, String bloodGroup, byte[] imageInBytes) {
        RelativeLayout viewToBeShared = (RelativeLayout) LayoutInflater.from(this).inflate(R.layout.layout_image1, null);
...
// Without it the view will have a dimension of 0,0 and the bitmap will be null
    ...
    private void shareOnFacebook(Uri uri) {
        ...
        if (!isFacebookAppFound) {
            Toast.makeText(ShareSkip1.this,"Please Install the Facebook application.", Toast.LENGTH_SHORT).show();
            publishImage1();
        }
    }
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ShareSkip1.this.startActivity(intent);
                    }
                });
