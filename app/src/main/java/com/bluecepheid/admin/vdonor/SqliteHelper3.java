...
public class SqliteHelper3 extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "bloodlist";
    ...
    public boolean saveUser (String id,String name)
    {
        ...
        if (cursor.getCount() == 0) { // Record does not exist
            ...
            result = db.insert("blood", null, contentValues);
        } else { // Record exists
            result = db.update("blood", contentValues, "id=?", new String[] { id });
        }
    ...
    public ArrayList<HashMap<String, Object>> getAllUsers() {
        ...
        String selectQuery = "SELECT  * FROM blood";
